//
//  CollectionViewHomeTableViewCell.swift
//  Ticketock
//
...
class HomeCollectionViewTableViewCell: UITableViewCell {
    ...
    static let identifier = String(describing: HomeCollectionViewTableViewCell.self)
    ...
    func configure(with movies: [MovieDetails]) {
        self.movies = movies
...
extension HomeCollectionViewTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setup(with: movies[indexPath.row].posterPath)
        return cell
    }
